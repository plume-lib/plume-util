 ...
 *   <dd>A union-find (disjoint-set) data structure that partitions elements into disjoint sets, with
 *       near-constant-time union and find. In addition to the usual operations, it can list all the
 *       elements of a set and maintain a unary and a binary predicate that are preserved across
 *       unions.
